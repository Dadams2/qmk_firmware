...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_5x7(
        ...
        KC_LCTL,   LGUI_T(KC_A), LALT_T(KC_S),   LSFT_T(KC_D), LCTL_T(KC_F), KC_G,  TAB_RO,
        ...
        KC_CAPS,   KC_LGUI, TAB_L,   TAB_R,
                    ...
                    QK_BOOT, KC_GRV,
        // right hand
                          KC_6,    KC_6,    KC_7,    KC_8,     KC_9,  KC_0,   KC_BSPC,
                          KC_RBRC, KC_Y,    KC_U,    KC_I,     KC_O,     KC_P,     KC_MINUS,
                      TG(_NUMPAD), KC_H  ,RCTL_T(KC_J), RSFT_T(KC_K) ,LALT_T(KC_L), RGUI_T(KC_SCLN),  KC_QUOT,
                                   KC_N,    KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,  KC_BSLS,
                                            KC_PLUS, KC_EQL,    KC_PLUS,  KC_EQL,
    ...
    [_FN] = LAYOUT_5x7(
        ...
        _______,   KC_LEFT,   KC_UP,    KC_DOWN,  KC_RGHT,   _______,  QK_BOOT,
